...
<div class="app-main__inner">
    <div class="app-page-title">
        <div class="page-title-wrapper">
           <div class="row"> <div class="page-title-heading">
                <div class="page-title-icon">
                    <i class="pe-7s-smile icon-gradient bg-mean-fruit"> 
                    </i>
                </div>
               
                 <div> <h1>Wecome to Your Dashboard</h1>
                    <div class="page-title-subheading"><h4>Ensure that all your details are correct.</h4>
                    </div>
